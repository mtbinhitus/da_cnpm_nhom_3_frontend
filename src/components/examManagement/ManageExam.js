...
function ManageExam() {
    ...
    if (colections === undefined || exams === undefined || loading === true) return   <LoadingOutlined
        style={{
            fontSize: "60px",
            color: "#0C5182",
            display: "flex",
        ...
        <>
            <Card style={{ paddingTop:"0px", padding:"35px" }}>
                <Grid container spacing={2} columns={16} style={{ paddingTop:"0px", paddingBottom:"35px" }}>
                    <Grid item xs={8}>
                        <h2 style={{color: "black", textAlign: "inherit", fontWeight: "700", marginLeft:"25px"}}>Quản lý đề thi</h2>
                    </Grid>
                    <Grid item xs={8}>
                        <div className="search_bar-create_btn-wrapper" style={{justifyContent:"right" , marginRight:"40px"}}>
                            <div id="create-btn-section" style={{justifyContent:"right"}}>
                                <button className="btn-createExam" style={{justifyContent:"right"}} onClick={()=>(setIsModalVisible(true))}>
                ...
                <Grid container spacing={2}>
                                ...
                                <div className="dropdown-toggle-state">
                                    <div className="dropdown-header-state">
                                        <div className="dropdown-title-state"
                                             style={{textAlign: "left", marginLeft: "10px"}}>Bộ đề thi
                                        </div>
                    ...
                    <div className="col-12" style={{ justifyContent: "center", marginTop:"40px"}}>
                        <h2 style={{ fontSize: "1rem", marginBottom: "5px",marginTop: "5px", fontWeight: "500", textAlign: "center", color: "blue"}} onClick={()=>{}}>
                            <Button style={{background:"#0C5182", borderRadius:"8px", borderColor:"#0C5182", border: "1px solid #0C5182"}}><h2 style={{ fontSize: "0.8rem", fontWeight: "500", color: "white"}}>Tìm kiếm</h2></Button>

                            <Button style={{marginLeft:"25px", borderRadius:"8px", borderColor:"#0C5182", border: "1px solid #0C5182"}}><h2 style={{ fontSize: "0.8rem", fontWeight: "500", color: "#0C5182"}}>Đặt lại</h2></Button>
                        </h2>
                    </div>
                    <div className="col-12" style={{ justifyContent: "center", marginTop:"20px"}}>
                        <h2 style={{color: "black", textAlign: "inherit", fontWeight: "700", marginLeft:"45px", fontSize:"20px"}}>Danh sách đề thi</h2>
                        <div className="Table-exam">
                            <TableContainer component={Paper} style={{borderColor:"#0C5182 !important", border: "3px solid #0C5182 !important", paddingTop:"25px"}}>
                                    ...
                                    <TableBody>
                                        {exams.data.map((row) => (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left">{row.collection ? row.collection.name : ""}</TableCell>
                                                <TableCell align="center">20</TableCell>
                                                <TableCell align="center">30</TableCell>
                                                <TableCell align="center"><EditIcon onClick={()=>{}}/></TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                                </Table>
                ...
                <div>
                    {
                        isModalVisible === false?
                            ""
                            :
                            <CreateExam isVisible={true} dataUser={[]} onData={handleDataChange} onRender={handleRender}/>
